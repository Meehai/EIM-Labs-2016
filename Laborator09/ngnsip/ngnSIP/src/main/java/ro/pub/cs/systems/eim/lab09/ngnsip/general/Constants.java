...
public interface Constants {
	...
	// TODO: exercise 4 - fill in the USERNAME, IDENTITY_IMPI, IDENTITY_PASSWORD
	final public static String USERNAME = "meehai";
	final public static String IDENTITY_IMPI = "getonsip_meehai";
	final public static String IDENTITY_PASSWORD = "ziSx5x7dwqncDCRr";
