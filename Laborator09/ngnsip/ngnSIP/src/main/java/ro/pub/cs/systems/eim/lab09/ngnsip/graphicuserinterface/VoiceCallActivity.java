...
public class VoiceCallActivity extends Activity {
	...
	private class RegisterButtonClickListener implements View.OnClickListener {
		...
		public void onClick(View view) {
			...
			boolean started = startNgnEngine();
			if(!started) {
				Log.e(Constants.TAG, "Eroare la deschiderea engine-ului");
				return;
			}
			registerSipService();
		}
	...
	private class MakeCallButtonListener implements View.OnClickListener {
		...
		public void onClick(View view) {
			...
			ngnAVSession = NgnAVSession.createOutgoingSession(NgnEngine.getInstance().getSipService().getSipStack(), NgnMediaType.Audio);
			...
			boolean calling = ngnAVSession.makeCall(validUri);
			if(calling) {
